...
In `11_rank_vs_skills_analysis/`:

1. **CERTIFICATIONS_RESEARCH_PLAN.md** - Comprehensive strategy guide
2. **CERTIFICATIONS_NO_SURVEY_APPROACH.md** - No-survey options
3. **CERTIFICATIONS_FULL_LANDSCAPE.md** - Cert ecosystem breakdown
4. **CERTIFICATION_SCOPE_STRATEGY.md** - Why deep-dive > broad survey
5. **CERTIFICATION_RESEARCH_PLAN.md** ← **START HERE FOR IMPLEMENTATION**
